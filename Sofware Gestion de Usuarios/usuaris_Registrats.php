...
<!-- Sección de superUsuario o super Administrador -->
...
<body>
    ...
    <div class="bienvenidaContainer">
        ...
        <div class="botones-bienvenida">
            ...
            <div class="copy">
                <button type="button" onclick="hacerCopiaSeguridadBD()" class="btn-baseDatos">Fer copia de seguretat BD</button>
            </div>
            <div class="restauraCopy">
                <button type="button" onclick="restaurarCopiaSeguridadBD()" class="btn-baseDatos" >Restaurar BD</button>
            </div>
        </div>
        <!-- Carterl de cancelar -->
        <div id="myModal" class="modal">
                ...
                <tbody>
                    <?php while ($row = mysqli_fetch_array($query)) : ?>
                        ...
                        <tr>
                            ...
                            <td><a href="#" onclick="confirmarEliminacion(<?= $row['ID'] ?>)" class="users-table-delete">Eliminar</a></td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
    ...
    <script>
        function hacerCopiaSeguridadBD() {
            window.location.href = "backUp.php";
        }
        function restaurarCopiaSeguridadBD() {
            window.location.href = "restauraBackUp.php";
        }
    </script>
</body>
